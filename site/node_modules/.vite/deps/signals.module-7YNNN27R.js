  ...
  if (!(v > 1)) {
    ...
    !(function() {
      ...
      while (void 0 !== i3) {
        var t4 = i3.S;
        if (t4.v === i3.v) {
          for (var n3 = t4.t; void 0 !== n3; n3 = n3.x) if (n3.i === i3.i) n3.i = t4.i;
        }
        i3 = i3.o;
      }
    })();
...
var k = function(i2) {
  for (var t3 in i2) {
    var n2 = i2[t3];
    if ("function" == typeof n2) i2[t3] = C2(n2);
...
function y2(i2) {
  var n2 = this, t3 = i2.data, f2 = useSignal(t3);
  f2.name = "ReactiveDom";
  f2.value = t3;
  var e2 = T(function() {
    var i3 = n2, t4 = n2.__v;
...
Object.defineProperties(l2.prototype, { constructor: { configurable: true, value: void 0 }, type: { configurable: true, value: y2 }, props: { configurable: true, get: function() {
  var i2 = this;
  ...
  if (n2.type !== S) {
    ...
    if (o2) {
      ...
      if (void 0 === (r2 = o2.__$u)) o2.__$u = r2 = (function(i3, n3) {
        ...
        r3.c = i3;
        return r3;
      })(/* @__PURE__ */ (function(i3) {
        return function() {
          var n3;
          if (p2) null == (n3 = this.y) || n3.call(this);
          i3.__$f |= 1;
          i3.setState({});
        };
      })(o2), "function" == typeof n2.type ? n2.type.displayName || n2.type.name : "");
    }
    h3 = o2;
    b2(r2);
  }
...
g2("diffed", function(i2, n2) {
  ...
  if ("string" == typeof n2.type && (r2 = n2.__e)) {
    var t3 = n2.__np, o2 = n2.props, f2 = r2.U;
    if (f2) for (var e2 in f2) {
      var u2 = f2[e2];
      if (!(void 0 === u2 || t3 && e2 in t3)) {
        u2.d();
        f2[e2] = void 0;
      }
    }
...
function w2(i2, n2, r2, t3) {
  var o2 = n2 in i2 && void 0 === i2.ownerSVGElement, f2 = y(r2);
...
var k2 = "undefined" == typeof requestAnimationFrame ? setTimeout : function(i2) {
  var n2 = function() {
    clearTimeout(r2);
...
function T3() {
  if (1 === m2.push(this)) (l.requestAnimationFrame || k2)(A2);
}
function x2() {
  n(function() {
    var i2;
...
function F() {
  if (1 === _2.push(this)) (l.requestAnimationFrame || q)(x2);
}
...
//# sourceMappingURL=signals.module-7YNNN27R.js.map
