...
\input{sections/figures_protocol.tex}

The closure contract mandates six layers: (i) all experiment arms complete; (ii) no
...
\begin{tabular}{@{}p{1.3cm}p{3.5cm}p{2.6cm}p{1.7cm}@{}}
\toprule
