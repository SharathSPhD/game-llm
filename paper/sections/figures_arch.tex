...
\begin{tikzpicture}[
  ...
  out/.style={draw, rounded corners=6pt, minimum width=2.4cm, minimum height=0.62cm, align=center, fill=black!3},
  ar/.style={-{Latex[length=2mm]}, gray!70},
...
\node[out] (sel) at (8.6,1.8) {$\arg\max_c \sum_i w_i \mathbb{1}[a_i \in c] + \tau \mathbb{1}[c = c_{\mathrm{ref}}]$};
